...
urlpatterns = [
    ...
    path("finance/receivables/customer.html", TemplateView.as_view(template_name="frontend/finance/receivables/customer.html")),
    path("finance/receivables/cashflow.html", TemplateView.as_view(template_name="frontend/finance/receivables/cashflow.html")),
    ...
    path("finance/payables/schedule.html", TemplateView.as_view(template_name="frontend/finance/payables/schedule.html")),
    path("finance/payables/confirm.html", TemplateView.as_view(template_name="frontend/finance/payables/confirm.html")),
    path("finance/payables/vendor.html", TemplateView.as_view(template_name="frontend/finance/payables/vendor.html")),
    path("finance/payables/aging.html", TemplateView.as_view(template_name="frontend/finance/payables/aging.html")),
    ...
    path("finance/payroll/base.html", TemplateView.as_view(template_name="frontend/finance/payroll/base.html")),
    path("finance/payroll/monthly.html", TemplateView.as_view(template_name="frontend/finance/payroll/monthly.html")),
    path("finance/payroll/calculate.html", TemplateView.as_view(template_name="frontend/finance/payroll/calculate.html")),
    path("finance/payroll/attendance.html", TemplateView.as_view(template_name="frontend/finance/payroll/attendance.html")),
    path("finance/payroll/adjustments.html", TemplateView.as_view(template_name="frontend/finance/payroll/adjustments.html")),
    path("finance/payroll/payment.html", TemplateView.as_view(template_name="frontend/finance/payroll/payment.html")),
    path("finance/payroll/detail.html", TemplateView.as_view(template_name="frontend/finance/payroll/detail.html")),
    ...
    path("finance/payments/bank.html", TemplateView.as_view(template_name="frontend/finance/payments/bank.html")),
    path("finance/payments/cash.html", TemplateView.as_view(template_name="frontend/finance/payments/cash.html")),
    path("finance/payments/source.html", TemplateView.as_view(template_name="frontend/finance/payments/source.html")),
    path("finance/payments/voucher.html", TemplateView.as_view(template_name="frontend/finance/payments/voucher.html")),
    ...
    path("finance/settings/tax.html", TemplateView.as_view(template_name="frontend/finance/settings/tax.html")),
