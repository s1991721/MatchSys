...
from bpmatch.views import (
    ...
    direct_technician_mail_content,
    direct_project_mail_content,
    send_mail,
    send_bulk_mail,
    queue_mail,
    send_tasks,
...
urlpatterns = [
    ...
    path(
        "api/direct-technician-mail-content",
        direct_technician_mail_content,
        name="direct_technician_mail_content",
    ),
    path(
        "api/direct-project-mail-content",
        direct_project_mail_content,
        name="direct_project_mail_content",
    ),
    ...
    path("api/send-mail-task", queue_mail, name="queue_mail"),
