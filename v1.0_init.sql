...
INSERT INTO sys_tasks (name,`time`,frequency,cron_expr,`method`,api,body,enabled,last_run_at,next_run_at,last_status,last_error,created_by,created_at,updated_by,updated_at,deleted_at) VALUES
	 ('夜间邮件处理','01:00:00','每天','0 1 * * *','POST','api/time-to-save','',1,'2026-02-13 16:00:00',NULL,'error','HTTP 403',1,'2026-01-04 14:51:21',1,'2026-02-13 16:00:00',NULL),
	 ('夜间过期邮件清理','05:00:00','每天','0 5 * * *','POST','api/time-to-clean','',1,'2026-01-10 20:00:00',NULL,'error','HTTP 500',1,'2026-01-04 15:20:48',1,'2026-01-10 20:00:00',NULL),
